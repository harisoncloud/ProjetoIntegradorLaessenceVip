<?php
    ...
    class MagicToolboxCoreInstallerClass {
        ...
        function sendStat($mode = '') {
            ...
            if('working' == 'v4.5.32' || 'working' == 'v4.6.12') {
                return;
            }
            ...
            $path = "api/stat/?action={$mode}&tool_name=magic360&license=trial&tool_version=v4.6.12&module_version=v4.5.32&platform_name=opencart&platform_version={$platformVersion}&url={$url}";
